    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h3 class="h3 mb-2 text-gray-800 text-gray">Add Training</h3>
                ...
                <div class="card-body">
                  <div class="form justify-content-centers">
                      ...
                      <form class="form" action="../includes/experience.php" method="post">
                        ...
                        <p class="text-center"><input type="submit" name="we-submit" class="btn btn-success mt-1" value="SUBMIT"></p>
                    </form>
                </div>
            </div>
          </div>
